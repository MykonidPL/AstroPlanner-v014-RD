(function(global){
  ...
  global.AstroRasterLayer={
    ...
    getStatus:()=>({ready:tileState==='tile✓'&&!failed,recovering:!!retryTimer,retryCount,maxRetries:MAX_RETRIES,lastError,source:DSS2_SURVEY,activeSurvey:'dss2-color',fullSky:true,aladinSize:aladin?.getSize?.()||null,tileState,diagnostics:diagnostics(),lastView:{...last}})
  };
})(window);
